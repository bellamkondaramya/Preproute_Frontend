...
// Only append /api for full backend URLs that do not already include it
if (
...
// If you are using JWT token in Authorization header, keep this false.
// Set true only if backend uses cookies/session authentication.
